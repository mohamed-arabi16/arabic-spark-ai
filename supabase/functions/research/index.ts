 ...
 * 
 * Performs web research using Perplexity API with streaming responses.
 * Returns well-sourced information with citations.
 * Creates a conversation to track the research session.
 */
