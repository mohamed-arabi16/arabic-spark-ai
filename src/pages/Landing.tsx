...
export default function Landing() {
  ...
  return <div className="min-h-screen bg-background" dir={i18n.dir()}>
      {/* Header — Glass Nav */}
      ...
      <section className="pt-40 pb-24 px-6 relative overflow-hidden">
        ...
        <motion.div className="container mx-auto text-center relative z-10 max-w-3xl" style={reducedMotion ? {} : {
        y: heroY,
        opacity: heroOpacity
      }}>
          {/* Glass pill badge */}
          <motion.div initial={reducedMotion ? {} : {
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          <motion.h1 initial={reducedMotion ? {} : {
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: 0.2,
          ease: [0.16, 1, 0.3, 1]
        }} className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed py-[15px]">
            {t('landing.subheadline')}
          </motion.p>

          <motion.div className="flex flex-col sm:flex-row gap-4 justify-center" initial={reducedMotion ? {} : {
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          <motion.p className="mt-6 text-sm text-muted-foreground" initial={reducedMotion ? {} : {
          opacity: 0
        }} animate={{
          opacity: 1
        }} transition={{
      ...
      <section className="py-24 px-6">
        <div className="container mx-auto max-w-5xl">
          <motion.div className="text-center mb-16" initial={reducedMotion ? {} : {
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          once: true
            ...
            {features.map((feature, index) => <motion.div key={index} variants={staggerItem} className="glass-card p-8 group" whileHover={reducedMotion ? {} : {
            y: -4,
            scale: 1.01
          }} transition={{
            duration: 0.2
      ...
      {/* CTA Section */}
      <section className="py-24 px-6">
        <motion.div className="container mx-auto max-w-2xl text-center" initial={reducedMotion ? {} : {
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
