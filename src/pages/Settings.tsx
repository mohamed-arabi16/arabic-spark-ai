...
export default function Settings() {
  ...
  const handleSave = () => {
    ...
    // Note: RTL logic is usually handled by i18n language change, but override was requested.
    // However, usually AR is RTL and EN is LTR. The user wants a toggle.
    // If language is AR, it's already RTL. If EN, usually LTR.
    // If user wants RTL in EN? Or LTR in AR? Assuming the toggle overrides direction regardless of language.
    // But realistically, it might just force RTL for Arabic if it was somehow LTR, or vice versa.
    // I'll assume it's for forcing a direction if auto-detect fails or for preference.
